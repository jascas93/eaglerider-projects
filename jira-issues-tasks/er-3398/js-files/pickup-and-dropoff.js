...
$(document).ready(function () {
    setTimeout(function() {
        ...
        else if (window.location.href.indexOf("?extended=1#go_to_widget") > 0) {
        ...
        else if (window.location.href.indexOf("extended=1#go_to_widget") < 1 && window.location.href.indexOf("extended=1") > 0) {
